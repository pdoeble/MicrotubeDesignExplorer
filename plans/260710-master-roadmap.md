...
- [x] Prepare independent scientific/accessibility review package and issue templates.
...
| 2026-07-11 | M9 release candidate deployed: `main` pushed to GitHub, first successful CI run `29140082451` passed, first successful Pages run `29140082435` passed, live URL `https://pdoeble.github.io/MicrotubeDesignExplorer/` serves the static app, full paper-default compute works on the deployed site, and deployed export smoke covers SVG, PNG, JSON, HTML, and print/PDF report popup. Later documentation-only pushes must keep CI/Pages green. M8/M9 remain in review because independent scientific/accessibility approval is still open; M10 release/tag publication remains blocked on that approval. | Codex                         |
...
| 2026-07-13 | Plot visual polish (W7, `/plans/260712-plot-visual-polish.md`): exact 256-entry `slanCM('spectral')` snapshot from MATLAB R2024b, cm-faithful paper layouts at any container width (round cross-section sketches), MATLAB colorbar/contour/grid conventions incl. reversed top bars via carrier traces; visual rounds r1–r3 closed findings F1–F16; F17–F19 and the final r4 verification round remain open in the subplan.                                                                                                                                                                               | Claude (plot polish)          |
